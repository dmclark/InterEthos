class UsersController < ApplicationController
  ...
  def create
    ...
    @user = User.new(params[:user].merge({:roles => @roles}))

    respond_to do |format|
      if @user.save_without_session_maintenance
        # UserMailer.activation_instructions(@user).deliver!
        format.html { redirect_to(root_url, :notice => 'Registration request received. An email verification was just sent to you.') }
